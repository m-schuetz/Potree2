...
function getDepthState(renderer){
	...
	if(!depthState){
		...
		if(FRESH_COMPILE){
			...
			compiled = new Uint32Array([119734787, 65536, 524296, 173, 0, 131089, 1, 393227, 1, 1280527431, 1685353262, 808793134, 0, 196622, 0, 1, 393231, 5, 4, 1852399981, 0, 11, 393232, 4, 17, 128, 1,
...
function getColorState(renderer){
	...
	if(!colorState){
		...
		if(FRESH_COMPILE){
			...
			compiled = new Uint32Array([119734787, 65536, 524296, 225, 0, 131089, 1, 393227, 1, 1280527431, 1685353262, 808793134, 0, 196622, 0, 1, 393231, 5, 4, 1852399981, 0, 11, 393232, 4, 17, 128,
