...
@group(0) @binding(1) var<storage_buffer> ssbo_source : U32s,
...
export function writeBuffer(
  renderer,
  { target, targetOffset, source, sourceOffset, size }
) {
  let { device } = renderer;
  ...
  device.queue.writeBuffer(gpuSource, 0, src.buffer, 0, src.byteLength);
