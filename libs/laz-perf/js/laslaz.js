...
import {WorkerPool} from "../../../src/misc/WorkerPool.js";

//let workerPath = "../workers/laz-loader-worker.js";
let workerPath = "../../../libs/laz-perf/workers/laz-loader-worker.js";
...
var LAZLoader = function(arraybuffer) {
	...
	this.ww = WorkerPool.getWorker(workerPath, {type: "module"});
